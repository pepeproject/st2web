...
export default class ConnectionFlexCard extends React.Component {
  static propTypes = {
  ...
  render() {
    const { connection, selected, onClick } = this.props;
